        ...
        <div class="row">
            ...
            <div class="col-md-5">
                <div class="product-details">
                    ...
                    <ul class="product-links">
                        <li>Share:</li>
                        <li><a href="https://www.facebook.com/profile.php?id=100006893440564"><i class="fa fa-facebook"></i></a></li>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-xs-6">
                <div class="product"> <a href="{{url('/view-details'.$related_product->id)}}">
