        ...
        <div class="row">
            ...
            <div class="col-md-4 col-xs-6">
                <div class="shop">
                    ...
                    <div class="shop-img">
                        <img src="{{asset('/storage/category/'.$category->image) }}"  style="width:350px; height:300px" alt=""  >
                    </div>
                            ...
                            <div class="products-slick" data-nav="#slick-nav-1">
                                ...
                                <div class="product">
                                    <div class="product-img"> <a href="{{url('/view-details'.$product->id) }}">
                                        <img src="{{asset('/image/'.$images)}}" style="width:200px; height:200px">
